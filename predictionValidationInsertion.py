...
from dataTypeValidationInsertionPrediction.dataTypeValidationDbInsertion import DbOperation
from dataTransformPrediction.dataTransformation import DataTransform
...
class PredictionValidation:
    ...
    def prediction_validation(self):
        """method name: train_validation
           description: method which validates the prediction data"""
        try:
            f = open("predictionMainLogs.txt", "a+")
